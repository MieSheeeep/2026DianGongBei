...
def search_storage_config_for_max_curtailment_scene(
    ...
    best_config = {
        ...
        "selection_rule": "economic_compromise minimizes unit/incremental production cost; absorption_oriented maximizes W4_P1 curtailment reduction",
        "W4_P1_before": {
...
def summarize_capacity_search(
    ...
    return {
        ...
        "explanation": (
            "Problem 4 autonomy estimate is based on the original 40 MW wind and 64 MW PV capacity baseline "
            "and checks all 24 scenarios and all hours. The annual production criterion is used only for "
            "economic comparison with the grid-connected case."
        ),
        "recommendation": {
            "report_note": "regular_load_autonomy gives the basic energy self-sufficiency capacity; full_production_autonomy gives the upper-bound capacity required to fully support 72 t/d production.",
