...
允许装置在最低负荷和满负荷之间连续变化，从而更细粒度地匹配风光出力。
...
从求解角度看，连续负荷率使各小时的可调空间可以在 $0.1$ 到 $1$ 之间连续分配。
当
\begin{equation}
  \alpha_{t,s}^{0}
...
其目标函数、功率平衡和产量约束均为线性形式，能够直接得到连续调节下的全局最优方案。
...
\begin{table}[H]
  ...
  \begin{tabular}{ccccc}
    ...
    \midrule
    72 & 7182.67 & 221146.80 & 12078.72 & 270/90/0 \\
    63 & 6413.13 & 176326.80 & 12078.72 & 300/60/0 \\
    54 & 5663.95 & 137231.50 & 17803.42 & 240/120/0 \\
    45 & 5008.76 & 109563.64 & 34955.56 & 240/120/0 \\
    36 & 4209.48 & 91060.62 & 61272.54 & 165/195/0 \\
    \bottomrule
  \end{tabular}
\end{table}
...
总净成本为 54\,554\,817.22~元，吨氨成本为 \textbf{4209.48~元/t}。
其新能源自发自用比例为 $64.24\%$、总用电绿电比例为 $41.95\%$，
均满足阈值；但新能源上网比例为 $35.76\%$，仍高于 $20\%$ 的要求。
这说明连续调节显著改善了新能源消纳，但在低日产量下，受总产量需求限制，
仍无法完全吸收高风光场景中的富余电量。
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.88\textwidth]{p3_dispatch_example.pdf}
...
4493.82~元/t 降至 4209.48~元/t，下降 284.35~元/t；$45~\mathrm{t/d}$
方案下降 281.55~元/t。成本降低的主要原因是连续负荷可以填补离散开停机
留下的时序空隙，使部分原本上网的新能源转化为内部制氨用电，并减少后续高价
时段的网购电量。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.82\textwidth]{p3_cost_compare_p2.pdf}
...
总用电绿电比例提高 8.26 个百分点，上网比例降低 9.46 个百分点。
这表明连续调节的主要价值不是改变总风光资源，而是改善风光出力与制氨负荷的
时序匹配关系。

\begin{figure}[H]
  \centering
  \includegraphics[width=0.78\textwidth]{p3_indicator_compare_p2.pdf}
  \caption{问题二与问题三成本最低方案的绿电直连指标对比}
  \label{fig:p3-indicator-compare}
\end{figure}

综合来看，连续制氨调节相较离散开停机具有更强的消纳能力和经济性优势：
...
$54~\mathrm{t/d}$ 可作为更均衡的方案，其全年吨氨成本为 5663.95~元/t，
自发自用比例为 $89.61\%$、总用电绿电比例为 $49.76\%$、上网比例为
$10.39\%$，三项指标均满足要求。
